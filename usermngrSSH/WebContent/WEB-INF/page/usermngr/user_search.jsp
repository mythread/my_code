...
<s:iterator value="result" id="UserSearchResultVO" status="i">
  ...
  ">
    ...
    <td><s:property value="#UserSearchResultVO.userid"/></td>
    <td><s:property value="#UserSearchResultVO.username"/></td>
    <td><s:property value="#UserSearchResultVO.email"/></td>
    <td><s:property value="#UserSearchResultVO.statusName"/></td>
  </tr>
