...
<body>
<s:form action="useredit" method="post" onsubmit="return validate()" theme="simple">
...
<table width="224" border="0" align="center">
  ...
  <tr>
    ...
    <td><s:textfield name="userid" id="userid" cssClass="input" readonly="true"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><s:password name="confirmpassword" id="confirmpassword" cssClass="input"/></td>
  </tr>
  <tr>
