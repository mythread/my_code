...
<html>
  ...
  <body>
  <h1>sharecount1.jsp</h1>
    <jsp:useBean id="counter" class="etp.bean.AccessCount" scope="application">
    <jsp:setProperty name="counter" property="firstPage" value="sharecount1.jsp"/>
    </jsp:useBean>
    <a href="sharecount2.jsp">sharecount2.jsp</a><br>
    <a href="sharecount3.jsp">sharecount3.jsp</a><br>
    统计：<br>
  firstPage： <jsp:getProperty name="counter" property="firstPage"/>
   访问： <jsp:getProperty name="counter" property="accessCount"/>次
