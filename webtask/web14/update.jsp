...
<h1 id="h1">会员修改</h1>
<form action="index.jsp" method="post" name="form1" id="form1" onsubmit="return system_error()">
  <table width="100%" border="0" align="center" class="tablestyle" >
    ...
    <tr>
      ...
      <td class="red" id="td"><label>
        <input name="username" type="text" class="left" id="username" onblur="validusername()" onchange="changeName()"/>
      </label><span id="usernameError"></span></td>
    </tr>
    <tr>
      <td class="tableside">设置密码:</td>
      <td class="red" id="td"><label>
        <input name="setpwd" type="password" class="left" id="userpassword" onblur="validuserpassword()" onchange="changePWD()"/>
    ...
    <tr>
      ...
      <td class="red" id="td">
        <label>
          <input name="pwd" type="password" class="left" id="password" onblur="validpassword()" onchange="isChangePWD()"/>
      </label><span id="pwdError"></span></td>
    </tr>
    <tr>
      <td class="tableside">邮箱:</td>
      <td class="red" id="td"><label>
        <input name="email" type="text" class="left" id="email" />
      </label></td>
    </tr>
    <tr>
