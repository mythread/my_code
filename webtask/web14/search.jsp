...
<h1 id="h1">会员查询</h1>
<form id="form1" name="form1" method="post" action="system_error.jsp" onsubmit="return TOinfo()">
    ...
    <tr>
      <td><table width="100%" border="0" class="tabletool">
        ...
        <tr>
          <td width="21%">会员ID:
            <label>
              <input name="userid" type="text" id="userid" size="10" onblur="validuserID()" onchange="changeID()" />
            </label></td>
          <td width="34%">会员名:
            <label>
              <input type="text" name="username" id="username"  onblur="validusername()" onchange="changeName()"/>
            </label></td>
